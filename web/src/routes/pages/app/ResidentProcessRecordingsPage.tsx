  ...
  return (
    <div style={{ display: "grid", gap: 12 }}>
      <div className="card">
        ...
        <p className="muted">
          Staff can log and update counseling session notes here. Admins keep delete access for record-control cleanup.
        </p>
        {error ? <div className="badge danger">{error}</div> : null}

        <div className="card" style={{ boxShadow: "none", marginTop: 10 }}>
          <div className="row" style={{ marginBottom: 10, flexWrap: "wrap" }}>
            <span className="badge ok">Prediction support: use resident risk for triage</span>
            <span className="badge">Observed fact: this note is the official session record</span>
          </div>
