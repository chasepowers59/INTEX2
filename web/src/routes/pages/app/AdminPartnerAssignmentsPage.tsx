        ...
        <div className="card">
          ...
          <div className="admin-inline-grid" style={{ marginTop: 10 }}>
            <label className="admin-form-label span-6">
              ...
              <input className="input" list="assignment-program-areas" value={programArea} onChange={(e) => setProgramArea(e.target.value)} placeholder="Leave blank for all" />
            </label>
            ...
            <div className="card process-form-card">
              ...
              <div className="admin-inline-grid">
                ...
                <label className="admin-form-label span-2">
                  ...
                  <input className="input" value={createForm.safehouseId} onChange={(e) => setCreateForm((p) => ({ ...p, safehouseId: e.target.value }))} placeholder="Optional" />
                </label>
                <label className="admin-form-label span-3">
                  <span className="muted">Program area</span>
                  <input className="input" list="assignment-program-areas" value={createForm.programArea} onChange={(e) => setCreateForm((p) => ({ ...p, programArea: e.target.value }))} />
                </label>
                <label className="admin-form-label span-2">
                ...
                <label className="row span-12" style={{ alignItems: "center" }}>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="row admin-compact-actions">
                        ...
                        <button className="btn admin-table-action" onClick={() => setEditId(null)}>
                          Cancel
                        </button>
                      </div>
                    </td>
